...
namespace Tanosvenyek_Console
{
    ...
    {
        public static List<Utvonal>? utvonalak { get; set; } = Utvonal.LoadFromJson("Fajlok/utak.json");
        public static List<Telepules>? telepulesek { get; set; } = Telepules.LoadFromJson("Fajlok/telepulesek.json");
